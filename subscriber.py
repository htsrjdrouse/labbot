...
def snap(cmd):
  ...
  (location,filename) = re.split("_", plocation)
  ccmd = "ssh pi@192.168.1.69 raspistill -w 320 -h 240 -ex sports --nopreview --timeout 1 -o \/home\/pi\/"+filename+checktm+timestamp+".jpg"
  print(ccmd)
  time.sleep(float(presnap))
  cccmd = "scp pi@192.168.1.69:\/home\/pi\/"+filename+checktm+timestamp+".jpg \/var\/www\/html\/labbot\/imaging\/"+location
  print(cccmd)
...
def on_message(client, userdata, message):
    ...
    if re.match("snap.*", cmd):
      ...
      print(checktm)
      (snap,location) = re.split(" ",cmd)
      print(location)
      ccmd = "ssh pi@192.168.1.69 raspistill -w 320 -h 240 -ex sports --nopreview --timeout 1 -o \/home\/pi\/"+checktm+timestamp+".jpg"
      print(ccmd)
      os.system(ccmd)
      time.sleep(1)
      cccmd = "scp pi@192.168.1.69:\/home\/pi\/"+checktm+timestamp+".jpg \/var\/www\/html\/labbot\/imaging\/"+location
      print(cccmd)
      os.system(cccmd)
